...
async def generate_availability_json(availability_text: str):
    ...
    prompt = (
        ...
        "indiquer si l'enseignant est disponible le matin ('matin': true/false) et/ou l'après-midi ('aprem': true/false). "
        "Exemple de JSON attendu :\n"
        "[\n"
        "    {\"date\": \"2024-12-09\", \"matin\": true, \"aprem\": true},\n"
        "    {\"date\": \"2024-12-10\", \"matin\": true, \"aprem\": false}\n"
        "]\n"
